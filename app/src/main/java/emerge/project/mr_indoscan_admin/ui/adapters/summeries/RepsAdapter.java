package emerge.project.mr_indoscan_admin.ui.adapters.summeries;
 ...
 */
public class RepsAdapter extends RecyclerView.Adapter<RepsAdapter.MyViewHolder> {

    Context mContext;
    ArrayList<Rep> repItems;


    public RepsAdapter(Context mContext, ArrayList<Rep> item) {
