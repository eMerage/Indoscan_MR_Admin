package emerge.project.mr_indoscan_admin.ui.activity.doctors;
...
import emerge.project.mr_indoscan_admin.ui.activity.summeries.SummerisActivity;
import emerge.project.mr_indoscan_admin.ui.activity.visits.VisitsActivity;
import emerge.project.mr_indoscan_admin.ui.adapters.doctors.DoctorMRFilterAdapter;
import emerge.project.mr_indoscan_admin.ui.adapters.doctors.DoctorsApprovedAdapter;
import emerge.project.mr_indoscan_admin.ui.adapters.doctors.DoctorsPendingAdapter;
import emerge.project.mr_indoscan_admin.ui.adapters.doctors.DocLocationDoctorsAdapter;
import emerge.project.mr_indoscan_admin.ui.adapters.doctors.DocLocationLocationAdapter;
import emerge.project.mr_indoscan_admin.ui.adapters.doctors.SpecializationAdapter;
...
import emerge.project.mr_indoscan_admin.utils.entittes.LocationEntitie;
...
import emerge.project.mr_indoscan_admin.utils.entittes.Specialization;
...
public class DoctorsActivity extends Activity implements DoctorsView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        doctorsPresenter.setNavigation();
    ...
    @OnItemClick(R.id.listview_navigation) void onItemClick(int position) {
        if (position == 0) {
            ...
            Intent intent = new Intent(this, SummerisActivity.class);
