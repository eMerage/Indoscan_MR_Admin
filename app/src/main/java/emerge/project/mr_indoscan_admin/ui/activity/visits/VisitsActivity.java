package emerge.project.mr_indoscan_admin.ui.activity.visits;
...
import emerge.project.mr_indoscan_admin.ui.adapters.visits.VisitsAdapter;
import emerge.project.mr_indoscan_admin.ui.adapters.visits.VisitsFilterDoctorsAdapter;
import emerge.project.mr_indoscan_admin.ui.adapters.visits.VisitsFilterLocationAdapter;
import emerge.project.mr_indoscan_admin.ui.adapters.visits.VisitsFilterProductAdapter;
import emerge.project.mr_indoscan_admin.ui.adapters.visits.VisitsFilterRepAdapter;
...
import emerge.project.mr_indoscan_admin.utils.entittes.Visit;
...
public class VisitsActivity extends Activity implements VisitsView {
    ...
    void onItemClick(int position) {
        if (position == 0) {
            ...
            Intent intent = new Intent(VisitsActivity.this, SummerisActivity.class);
